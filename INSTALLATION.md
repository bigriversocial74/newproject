...
The first account is created as an active verified `customer_owner` and receives platform-operator access. The browser setup page permanently locks after the first account or user is created.
