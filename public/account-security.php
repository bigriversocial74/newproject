...
<section id="team-section" class="panel section-space" hidden><header class="panel-head"><div><h3>Account Team</h3><p>Owners and administrators can invite members and manage account roles.</p></div><button class="button primary" id="invite-member" type="button" disabled>Invite Member</button></header><div id="team-members" class="list"><div class="empty">Loading team…</div></div><div class="section-divider"></div><h4>Invitations</h4><div id="team-invitations" class="list"><div class="empty">Loading invitations…</div></div></section>
